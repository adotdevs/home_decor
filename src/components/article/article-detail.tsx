...
import { resolveArticleFeaturedAlt, resolveArticleInlineImageAlt } from "@/lib/image-alt";
          ...
          <div className="min-w-0">
            ...
            {article.featuredImage ? (
              <figure className="mt-10 overflow-hidden rounded-3xl border border-black/5 shadow-lg">
                ...
                <img
                  ...
                  alt={resolveArticleFeaturedAlt(article)}
            ...
            <div className="prose prose-neutral mt-12 max-w-none space-y-6 dark:prose-invert">
              {blocks.map((block, i) => {
                ...
                if (block.type === "image") {
                  const altResolved = resolveArticleInlineImageAlt(article, block);
                  const showCaption = Boolean(block.alt?.trim());
                  return (
                    <figure
                      key={i}
